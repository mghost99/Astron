...
# MongoDB build #
**updated 11/09/2025**
*The commands below assume you are using a Linux distro with a base of 25.10*

This should be all packages needed for Astron itself:
```
...
Install MongoDB Communtiy Server:
